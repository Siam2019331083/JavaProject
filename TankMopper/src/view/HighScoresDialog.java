...
public class HighScoresDialog extends JDialog {
	...
	private void createGUIControl(JFrame frame, String gameLevel, 
		...
		Font largeFont = TankMopperFont.getBoldFont(18);
		Font subTitleFont = TankMopperFont.getBoldFont(16);
		Font mediumFont = TankMopperFont.getBoldFont(14);
		Font smallFont = TankMopperFont.getBoldFont(12);
	...
	private int createGUIScoreLine(JPanel panel, int gridy, Font smallFont,
			int count, TankMopperScore score) {
	...
	private String getSubTitle(String gameLevel) {
		...
		sb.append(gameLevel);
		sb.append(" TankMopper Game Level");
		return sb.toString();
	}
