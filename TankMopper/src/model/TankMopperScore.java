...
public class TankMopperScore implements Cloneable {
	...
	public TankMopperScore() {

	}

	public TankMopperScore(int gameLevel, long milliseconds, String displayTime) {
	...
	public String toString() {
		return "TankMopperScore [gamelevel=" + gameLevel + ", milliseconds="
